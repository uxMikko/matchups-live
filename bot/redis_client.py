...
async def push_state(
    ...
    fixture_probs, elo_ratings, real_odds, tournament_probs=None,
):
    """Write all Redis state keys atomically-ish."""
    import time
    ...
    if tournament_probs is not None:
        await redis_set("tournament_probs", tournament_probs)
